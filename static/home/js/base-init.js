...
(function ($) {
	...
	$('[data-toggle=tab]').on('click', function () {
		...
		if ($(this).hasClass('active') && $(this).closest('ul').hasClass('ajolive-body-tabs')) {
		...
		topUserSearch.selectize({
			...
			options: [{
				...
				},
				{
					...
					icon: 'ajolive-star-icon'
				}
			],
			render: {
				option: function (item, escape) {
					return '<div class="inline-items">' +
						(item.image ? '<div class="user-thumb"><img src="' + escape(item.image) + '" alt="avatar"></div>' : '') +
